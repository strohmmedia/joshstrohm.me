#!/usr/bin/env python3
"""Generate a blog image. Saves to public/images/blog/<slug>.jpg"""
...
def main():
    ...
    out_dir = repo_root / "public" / "images" / "blog"
    ...
    try:
        ...
        with open(dst, 'wb') as f:
            f.write(data)
        print(f"public/images/blog/{slug}.jpg")
    except Exception as e:
        # fallback minimal gray jpeg so pipeline continues
